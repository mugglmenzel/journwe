...
ssh $ssh_opts_terminal $ssh_host "sudo aptitude -y update"
ssh $ssh_opts_terminal $ssh_host "sudo aptitude -y install unzip"
ssh $ssh_opts_terminal $ssh_host "sudo aptitude -y install openjdk-6-jre"
