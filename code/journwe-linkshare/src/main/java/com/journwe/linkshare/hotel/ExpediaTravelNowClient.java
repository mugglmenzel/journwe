...
public class ExpediaTravelNowClient extends Client {
	...
	public ExpediaTravelNowClient(String affiliateId) {
		super(affiliateId);
	}

	public ExpediaTravelNowClient() {
		super("455210");
	}
	...
	public void extractPastedLink(String pastedLink) {
		...
		String afterQuestionMarkString = split2[3].split("\\?")[1];
	...
	public static void main(String[] args) {
		ExpediaTravelNowClient client = new ExpediaTravelNowClient();
		List<Room> rooms = new ArrayList<Room>();
