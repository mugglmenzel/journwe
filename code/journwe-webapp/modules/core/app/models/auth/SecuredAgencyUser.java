...
public class SecuredAgencyUser extends Security.Authenticator {
	...
	public Result onUnauthorized(Context ctx) {
		ctx.flash().put(GlobalParameters.FLASH_ERROR_KEY, "Nice try, but you need to log in first! Access is restricted to travel agencies only.");
    ...
    public static boolean isUser(AuthUser u) {
        return UserManager.findByAuthUserIdentity(u) != null && EUserRole.AGENCY.equals(UserManager.findByAuthUserIdentity(u).getRole());
