...
public class SecuredAgency extends Security.Authenticator {
	...
	public Result onUnauthorized(Context ctx) {
		ctx.flash().put(GlobalParameters.FLASH_ERROR_KEY, "Nice try, but you need to log in first! Access is restricted to selected BETA users only.");
